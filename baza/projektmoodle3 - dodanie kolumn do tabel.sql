...
--
-- Host: 127.0.0.1
-- Czas generowania: 24 Paź 2015, 20:34
...
(2, 1, 'Siedzenie i nic nie robienie', 'idz_sie_lecz', 'blocked');
...
INSERT INTO `lekcje` (`id_lekcji`, `id_kursu`, `temat`, `tresc`, `plik_nauczyciela`) VALUES
(1, 1, 'Dlaczego ludzie programujo ?', 'Ludzie programujo, bo mogo. Dzienkuje, dobranoc.', NULL),
(2, 1, 'Programowanie a kopiowanie', 'Jest to dosyć ciekawe zagadnienie. Bardzo dużo ludzi kopiuje treść programów by programować szybciej i lepiej.<br> Można zrobić test HTML <b>To pogrubione</b>, <a>natomiast jest to link</a>.', NULL),
...
--
ALTER TABLE `zapisy`
  MODIFY `id_zapisu` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
