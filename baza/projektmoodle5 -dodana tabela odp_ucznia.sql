...
--
-- Host: 127.0.0.1
-- Czas generowania: 02 Lis 2015, 11:19
...
(1, 1, 4, 'jakis_plik.txt', 'ble.txt', '2015-11-02', '', ''),
...
--
-- AUTO_INCREMENT dla tabeli `odp_ucznia`
--
ALTER TABLE `odp_ucznia`
  MODIFY `id_pliku` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
